...
# download videos from nextcloud
mkdir -p ./src/assets/videos
wget https://cloud.uni-hamburg.de/s/eSxqLtrZbdnorxp/download/drugstone_overview.mp4 -O ./src/assets/videos/drugstone_overview.mp4
