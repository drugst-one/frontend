...
@Component({
  standalone: true,
  imports: [CommonModule, CodeComponent, TabsModule, TableModule],
...
export class CustConfigComponent implements OnInit {
  ...
  ngOnInit() {
    this.config = [
      ...
      { name: 'taskTargetName', type: 'string', default: 'Target identification', description: 'Label of the button for the target identification.'},
      {name: 'taskDrugName', type: 'string', default: 'Drug Search', description: 'Label of the button for the drug search.'},
      { name: 'clusteringName', type: 'string', default: 'Clustering', description: 'Label of the button for the clustering.' },
      { name: 'pathwayEnrichment', type: 'string', default: 'Pathway enrichment', description: 'Label of the button for the pathway enrichment.' },
      ...
      { name: 'showNetworkMenuButtonSelectionMultiDrag', type: 'boolean', default: 'true', description: 'Show or hide the button to toggle the selection multi-drag.' },
      ...
      { name: 'networkMenuButtonSelectionMultiDragLabel', type: 'string', default: 'Multi-Drag', description: 'Label of the button to toggle the selection multi-drag.' },
      ...
      { name: 'approvedDrugs', type: 'boolean', default: 'false', description: 'Only show approved adjacent drugs.' },
