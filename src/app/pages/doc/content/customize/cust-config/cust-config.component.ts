...
export class CustConfigComponent implements OnInit {
  ...
  ngOnInit() {
    this.config = [
      ...
      {name: 'interactionDrugProtein', type: 'string', default: 'NeDRex', description: 'The drug database which should be used to fetch the drug-protein interactions. Possible values are "DrugBank", "Chembl", "DGIdb".'},
      {name: 'interactionProteinProtein', type: 'string', default: 'NeDRex', description: 'The database which should be used to fetch the protein-protein interactions. Possible values are "STRING", "BioGRID", "APID".'},
      {name: 'indicationDrugDisorder', type: 'string', default: 'NeDRex', description: 'The database which should be used to fetch the drug-disorder interactions. Possible values are "DrugBank", "NeDRex".'},
      {name: 'associatedProteinDisorder', type: 'string', default: 'NeDRex', description: 'The database which should be used to fetch the protein-disorder interactions. Possible values are "NeDRex", "DisGeNET".'},
      ...
      {name: 'useNedrexLicenced', type: 'boolean', default: 'false', description: 'Indicates whether licenced data shuld be used. If set to true, users will have to accept the terms of usage for the licenced data.'},
